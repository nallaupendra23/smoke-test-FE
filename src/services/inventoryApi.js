...
export const inventoryApi = {
  ...
  // AI auto-map: creates MenuIngredient rows for all unmapped dishes
  autoMap: () =>
    api.post('/inventory/auto-map'),

  // Per-dish preparation cost breakdown
  getMenuItemCosts: () =>
    api.get('/inventory/menu-item-costs'),
  ...
  extractInvoice: (formData) =>
    api.post('/inventory/invoice/extract', formData, {
      headers: { 'Content-Type': null },  // null removes default so browser sets correct multipart boundary
    }),
}
