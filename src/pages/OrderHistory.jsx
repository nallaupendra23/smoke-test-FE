        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{
              ...
              fontSize: 12,
              fontWeight: 700,
              boxShadow: '0 2px 6px rgba(170,48,26,0.22)',
            }}>{itemCount}</span>
        ...
        {!isDone && (
          <div style={{
            ...
            <button
              ...
              onMouseEnter={e => {
                e.currentTarget.style.background = 'rgba(170,48,26,0.06)'
                e.currentTarget.style.color = '#aa301a'
                e.currentTarget.style.borderColor = 'rgba(170,48,26,0.18)'
              }}
              onMouseLeave={e => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width: 72, height: 72,
        borderRadius: 22,
        background: 'linear-gradient(135deg, rgba(170,48,26,0.07), rgba(203,72,48,0.07))',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        margin: '0 auto 20px',
...
export default function OrderHistory() {
  ...
  // History totals are based on completed successful orders and cancelled orders.
  const stats = {
    total: orders.length,
    successful: orders.filter(o => o.status === 'picked_up').length,
  ...
  return (
    <Layout>
      ...
      <div className="orders-page app-page app-page-wide" style={{
        minHeight: '100vh',
        ...
        <PageHeader
          icon={OrdersIcon}
          title="Orders"
          subtitle={`${periodDays ? `Last ${periodDays} days` : 'All orders'} · ${stats.total} total`}
          accent="var(--accent-amber)"
          accentBg="rgba(242,184,75,0.14)"
        >
            <div className="page-toolbar">
              <div className="segmented-tabs" style={{ border: '1px solid rgba(0,0,0,0.08)' }}>
                <button
                ...
                <button
                  ...
                  style={{
                    ...
                    color: '#fff',
                    boxShadow: '0 2px 8px rgba(170,48,26,0.25)',
                  }}
                >
                  Orders
                </button>
                ...
                {PERIOD_TABS.map(t => (
                  <button
                    ...
                    style={{
                      ...
                      color: periodDays === t.value ? '#aa301a' : '#86868b',
        ...
        <div style={{
          ...
          <StatPill label="Successful" value={stats.successful} color="#30D158" glow="rgba(48,209,88,0.15)" />
          <StatPill label="Cancelled" value={stats.cancelled} color="#FF453A" glow="rgba(255,69,58,0.14)" />
          <StatPill label="Revenue" value={`$${stats.revenue.toFixed(0)}`} color="#aa301a" glow="rgba(170,48,26,0.12)" />
          <StatPill label="Loss" value={`$${stats.loss.toFixed(0)}`} color="#FF453A" glow="rgba(255,69,58,0.12)" />
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            padding: '7px 12px',
            borderRadius: 10,
            background: dateFilter ? 'rgba(170,48,26,0.06)' : 'rgba(0,0,0,0.03)',
            border: dateFilter ? '1px solid rgba(170,48,26,0.15)' : '1px solid rgba(0,0,0,0.04)',
            transition: 'all 0.2s ease',
          }}>
            <span style={{ color: dateFilter ? '#aa301a' : '#aeaeb2', flexShrink: 0 }}><CalendarIcon /></span>
            <input
              type="date"
              value={dateFilter}
              ...
              style={{
                ...
                outline: 'none',
                fontSize: 12,
                color: dateFilter ? '#aa301a' : '#86868b',
                fontWeight: 500,
                cursor: 'pointer',
              }}
            />
            {dateFilter && (
              <button
                ...
                style={{
                  border: 'none', background: 'rgba(170,48,26,0.10)',
                  borderRadius: '50%', width: 16, height: 16,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  cursor: 'pointer', color: '#aa301a', fontSize: 10, fontWeight: 700,
                }}
              >
                ✕
              </button>
        ...
        <div style={{
          ...
          {loading ? (
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              <EmptyState filter={search || dateFilter} />
            </div>
          ) : (
